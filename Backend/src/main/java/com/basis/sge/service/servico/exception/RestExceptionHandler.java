...
import com.basis.sge.service.servico.exception.dtoErros.ErrorResponse;
import com.basis.sge.service.servico.exception.dtoErros.ObjectError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ErrorResponse getErrorResponse(MethodArgumentNotValidException ex, HttpStatus status, List<ObjectError> errors) {
        ...
        return new ErrorResponse(errors.get(0).getMessage(), status.value(),
